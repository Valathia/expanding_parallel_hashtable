...
case $VERSION in
    a)
        ...
        gcc -Wshadow bench_.c libexpht.a -O3 ${DEBUG_FLAG} ${LOCK} ${TIMED_FLAG} -lpthread -o bench
    ;;
    b)
    ...
    e)
        ...
        gcc -Wshadow bench_.c libexpht.a -O3 ${DEBUG_FLAG} ${LOCK} ${TIMED_FLAG} -DARRAY=1 -lpthread -o bench   
    ;;
    f)
